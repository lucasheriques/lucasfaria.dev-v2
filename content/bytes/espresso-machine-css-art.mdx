...
abstract: "A CSS art of an espresso machine. Features some React state as well to pour some coffee on press." date: "2024-02-15"
---
...
<Sandpack template="react" files={{
        "/App.module.css": `.espressoMachine {
  position: relative;
  width: 200px;
  height: 220px;
  margin: 16px auto;
