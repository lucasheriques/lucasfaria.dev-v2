...
export function TooltipContent({ close }: TooltipContentProps) {
  return (
    <div className="flex flex-col items-center justify-center gap-4">
      <div className="m-4 flex flex-col items-center gap-8 rounded-3xl border-4 border-dotted border-amber-600 bg-amber-100 p-4 font-medium dark:border-purple-900 dark:bg-slate-900">
