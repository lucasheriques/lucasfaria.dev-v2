...
import { ariaFocusRing, composeTailwindRenderProps } from "./utils";
...
const itemStyles = tv({
  extend: ariaFocusRing,
  base: "relative flex gap-3 cursor-default select-none py-2 px-3 text-sm text-gray-900 dark:text-zinc-200 -outline-offset-2",
  variants: {
    isSelected: {
